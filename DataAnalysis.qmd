...
```{r}
survey <- fread('fashion_survey.csv')
...
```{r}
include_graphics("survey-men.png")
```

```{r}
include_graphics("survey-women.png")
```

```{r}
include_graphics("images-men.png")
```

```{r}
include_graphics("images-women.png")
```
